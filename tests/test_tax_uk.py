...
class TaxUKTest(unittest.TestCase):
    ...
    def test_corporation_taxcalc(self):
        ...
        assert uk_corporation_tax_rate('2014', -11000) == (p(0.20), p(2200))
        assert uk_corporation_tax_rate('2014', p(-11000)) == (p(0.20), p(2200))
        assert uk_corporation_tax_rate(2014, 11000) == (p(0.21), p(0))  # Making a loss
        assert uk_corporation_tax_rate(2014, 0) == (p(0.21), p(0))  # Case of zero
