...
INSERT INTO chart_of_accounts (chart, code, name, category) VALUES ('FY_Summary', 91, 'Depreciation', 'Expense');
INSERT INTO chart_of_accounts (chart, code, name, category) VALUES ('FY_Summary', 92, 'Amortisation', 'Expense');
INSERT INTO chart_of_accounts (chart, code, name, category) VALUES ('FY_Summary', 93, 'Interest', 'Expense');
INSERT INTO chart_of_accounts (chart, code, name, category) VALUES ('FY_Summary', 94, 'Tax on(loss)/profit on ordinary activities', 'Expense');
INSERT INTO chart_of_accounts (chart, code, name, category) VALUES ('FY_Summary', 96, 'Dividends', 'Expense');
